...
public class GameStart extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Boolean toFill=sharedpreferences.getBoolean("Database",false);
        if(toFill==false)
        {
            fillindata();
        ...
        btn=(Button)findViewById(R.id.contbtn);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ii.setClass(GameStart.this, QuizActivity.class);
